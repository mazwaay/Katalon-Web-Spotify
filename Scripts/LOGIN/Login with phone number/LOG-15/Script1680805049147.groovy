...
WebUI.setText(findTestObject('Login-Repo/PhoneNumber_inputText'), GlobalVariable.notRegistered_number)

WebUI.click(findTestObject('Login-Repo/Next_button(enterphone)'))

WebUI.setText(findTestObject('Login-Repo/OTP_inputText'), '000000')

WebUI.verifyElementText(findTestObject('Login-Repo/Assert-verify-element/Assert_send_OTP'), 'We sent an SMS with a 6-digit code to +6287711544294.')
