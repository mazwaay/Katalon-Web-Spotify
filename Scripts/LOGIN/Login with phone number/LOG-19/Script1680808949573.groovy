...
WebUI.setText(findTestObject('Login-Repo/PhoneNumber_inputText'), GlobalVariable.MoreThan12_number)

WebUI.click(findTestObject('Login-Repo/Next_button(enterphone)'))

WebUI.verifyElementText(findTestObject('Login-Repo/Assert-verify-element/Assert_invalid_PhoneNumber'), 'Check your phone number.')
